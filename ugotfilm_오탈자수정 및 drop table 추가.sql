...
--배우
DROP TABLE ugotfilm_person_cast;
...
-- 감독
drop table ugotfilm_person_crew;
...
-- 유저 선택 기록 (인물)
drop table ugotfilm_person_choice;
...
INSERT INTO ugotfilm_person_choice VALUES (1, 1056121, sysdate); -- 사람
